...
Na poczπtku za pomocπ komendy \texttt{docker login inzynierkakeycloak.azurecr.io} zalogowano siÍ do rejestru kontenerÛw Azure.
...
komendy \texttt{docker build . -t frontend} zbudowano obraz o nazwie ,,frontend''.

NastÍpnym krokiem by≥o powiπzanie zbudowanego obrazu z nazwπ jakπ bÍdzie mia≥ ten obraz w rejestrze kontenerÛw. Do tego celu uøyto 
komendy \texttt{docker tag frontend inzynierkakeycloak.azurecr.io/technologie-programistyczne:latest}.

Ostatnim krokiem by≥o wrzucenie tak skonfigurowanego obrazu do rejestru kontenerÛw, gdzie na podstawie tego obrazu zostanie utworzony kontener aplikacji. Do tego celu uøyto komendy \texttt{docker push inzynierkakeycloak.azurecr.io/technologie-programistyczne:latest}.
...
NastÍpnym krokiem by≥o zbudowanie obrazu Dockerowego za pomocπ komendy \texttt{docker build . -t backend}.

NastÍpnie powiπzano zbudowany obraz z nazwπ jakπ bÍdzie mia≥ ten obraz w rejestrze kontenerÛw. Do tego celu uøyto komendy 
\texttt{docker tag backend inzynierkakeycloak.azurecr.io/technologie-programistyczne-backend:latest}.

Ostatnim krokiem by≥o wrzucenie tak skonfigurowanego obrazu do rejestru kontenerÛw, gdzie na podstawie tego obrazu zostanie utworzony kontener aplikacji. Do tego celu uøyto komendy \texttt{docker push inzynierkakeycloak.azurecr.io/technologie-programistyczne-backend:latest}.
...
\begin{figure}[H]
	...
	\caption*{èrÛd≥o: Opracowanie w≥asne - zrzut ekranu z programu Postman}
\end{figure}
...
Podsumowanie konfiguracji wdroøeniowej serwera uwierzytelniajπcego i autoryzujπcego jest przedstawione na rysunku~\ref{fig:wdrozenie-warstwy-bezpieczenstwa}.
...
rysunku~\ref{fig:wdrozenie-warstwy-bezpieczenstwa-1}
...
\section{Podsumowanie wdroøenia}
